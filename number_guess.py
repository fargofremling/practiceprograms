...
def number_guess():
    while True:
        ...
        while True:
            try:
                user_number = int(raw_input("I'm thinking of a number between 1 and 10."
                 " Take a guess. \n> "))

                while user_number != comp_number:
                    if user_number < 1:
                        print "You're not good with instructions, are you? Your guess is"
                        " BELOW the range of 1 to 10."
                        user_number = int(raw_input("Guess a number that is 1 or above, "
                        "and 10 or below. \n> "))
                        ...
                        user_number = int(raw_input("Guess a number that is 10 or below, "
                        "and 1 or above. \n> "))
...
# Items remaining: Change how the program continues if the exception is encountered. 
# It works fine today, but I believe there is a better way to handle this.